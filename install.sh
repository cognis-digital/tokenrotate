#!/usr/bin/env sh
# Universal installer for tokenrotate. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/tokenrotate.git"
echo "Installing tokenrotate ..."
...
echo "Done. Run: tokenrotate --help"
