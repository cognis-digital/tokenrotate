"""TOKENROTATE core — Plan + track secret rotation across providers from an inventory."""
...
RULES = [
    ("TOK-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("TOK-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("TOK-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
