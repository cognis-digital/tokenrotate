"""Native cognis-connect emit for tokenrotate — forward findings to any platform.

Maps tokenrotate's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    tokenrotate ... --format json | tokenrotate-emit --to stix
    tokenrotate-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
